                    ...
                    <div class="widget widget-latest-post">
                        ...
                        <div class="media">
                            <a class="pull-left" href="#!">
                                <img class="media-object" src="{{asset('assets/images/blog/post-thumb.jpg')}}" alt="Image">
                            </a>
                        ...
                        <div class="media">
                            <a class="pull-left" href="#!">
                                <img class="media-object" src="{{asset('assets/images/blog/post-thumb-2.jpg')}}" alt="Image">
                            </a>
                            <div class="media-body">
                        ...
                        <div class="media">
                            <a class="pull-left" href="#!">
                                <img class="media-object" src="{{asset('assets/images/blog/post-thumb-3.jpg')}}" alt="Image">
                            </a>
                            <div class="media-body">
            ...
            <div class="col-md-8">
                <div class="post">
                    ...
                    <div class="post-content">
                        ...
                        <a href="{{route("blog-detail")}}" class="btn btn-main">Continue Reading</a>
                    </div>
